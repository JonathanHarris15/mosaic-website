/**
 * @fileoverview MS-554 — Person account-rank backfill (MS-539).
 *
 ...
 * next touched. Without this pass the Trade picker would fail closed for
 * every existing Linked User on a members-only Event.
 *
