    ...
    return {
      ...
      render: function () {
        ...
        function draw(items, rect, command) {
          if (!popup) { popup = document.createElement("div"); popup.style.cssText = "position:fixed;z-index:9999;background:var(--surface-container-lowest);border:1px solid #c5c6d0;border-radius:8px;box-shadow:0 4px 16px rgba(0,0,0,.12);min-width:200px;max-height:260px;overflow-y:auto;padding:4px 0;font-family:var(--font-sans);font-size:14px;"; document.body.appendChild(popup); }
          ...
          items.forEach(function (it, i) {
            ...
            b.style.cssText = "display:block;width:100%;text-align:left;padding:7px 16px;cursor:pointer;border:none;background:" + (i === sel ? "var(--primary-fixed)" : "transparent") + ";color:#1c1c18;font-size:14px;font-family:inherit;";
