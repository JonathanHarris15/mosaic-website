...
test('the GitHub Actions deploy workflow ships both halves and stays on monitor', () => {
    ...
    assert.match(wf, /--only hosting,functions:publicForm,functions:onAttendanceCreated,functions:syncAccountRankToPerson,functions:sendPrayerRequestNow,functions:mcp,functions:adminNotificationOverview,functions:adminPushDevices,functions:adminRevokePushToken,functions:adminSendSelfPushTest,firestore:rules,firestore:indexes/,
    ...
    assert.match(ops, /hosting,functions:publicForm,functions:onAttendanceCreated,functions:syncAccountRankToPerson,functions:sendPrayerRequestNow,functions:mcp,functions:adminNotificationOverview,functions:adminPushDevices,functions:adminRevokePushToken,functions:adminSendSelfPushTest,firestore:rules,firestore:indexes/,
    ...
    assert.match(index, /exports\.adminSendSelfPushTest\s*=\s*onCall/,
        'adminSendSelfPushTest is not exported; MS-682 deploy target would ship nothing');
});
