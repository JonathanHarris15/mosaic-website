...
(function (global) {
    ...
    function arbitrate(spec) {
        ...
        if (s.chosen) {
            ...
            // ⚠ AND IT HAS TO BE A PLACE, NOT A PROBLEM. Sarah offered her
            // Coffee and then declined it herself. It is still hers, so nothing
            // has "moved" — but handing Bob a place that is already looking for
            // cover is handing him the thing he was trying to get rid of.
            if (back.state === DECLINED) return no(REASONS.OFFERED_DECLINED);
