...
//
// Copied from public/shepherding-core.js by scripts/sync-shared-to-functions.js, because
...
(function (global) {
    ...
    // ── Note Type ─────────────────────────────────────────────────────────────
    // The categories a Shepherding Note can carry. Extensible — an elder may
    // type a new one — but these are the ones the app ships knowing about, and
    // a caller that cannot ask a person (the MCP, MS-278) is held to them: a
    // made-up seventh type is invisible in every filter built on the real six.
    const NOTE_TYPES = [
        'Elder Check-in', 'Elder Interview', 'Elder Meeting',
        'Life Update', 'Prayer Request', 'Other',
    ];
