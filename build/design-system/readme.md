...
- **Type:** serif-led. **Cinzel** (caps) for page titles only; **EB Garamond** for hymn names, roles, and anything read rather than operated; **Libre Franklin** for *all* chrome — labels, meta, buttons, inputs, nav. Titles use slightly positive tracking (+0.02em); labels are tracked caps (+0.14em).
